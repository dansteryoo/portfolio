        ...
        return (
            <div className="mid-container">
                <div className="mid-top-container">
                    ...
                    <ScrollAnimation animateIn="fadeIn" delay={400}>
                        <p className="third-text">
                            ...
                            applications and websites that solves real life
                            problems for real life people. Check out my projs
                            below!
                        </p>
                    </ScrollAnimation>
                    ...
                    <ScrollAnimation animateIn="fadeIn">
                        ...
                        <div className="prof-container">
                            <div className="bio-text">
                                <p>
                                    Hello! I'm Danny, a software engineer based
                                    in Queens, NY. I'm an avid pizza lover, and
                                    a loyal sports fanatic to my lowly Jets,
                                    Mets, Rangers, and Knicks. I love to learn
                                    and I am currently learning to love how to
                                    program solutions for real life problems.
                                    Some of my upcoming projs are solutions to
                                    problems I have personally dealt with
                                    throughout my professional career. You can
                ...
                <div className="Experience-Container">
                    <ScrollAnimation animateIn="fadeIn">
                        <div className="experience-header">My projs</div>
                    </ScrollAnimation>
                    <div className="innter-container">
                                ...
                                <div className="proj-1-rightside">
                                    ...
                                    <div className="proj-description">
                                        <p className="proj-description-text">
                                            A simple VBS manager to assist
                                            churches and parents manage their
                                            information easier.
                                        </p>
                                    </div>
                                    <div className="proj-1-links">
                        ...
                        <ScrollAnimation animateIn="zoomIn">
                            <div className="proj-2">
                                <div className="proj-2-rightside">
                                    ...
                                    <div className="proj-description">
                                        <p className="proj-description-text">
                                            A website where users can journal
                                            their devotionals using the "She
                                            Reads Truth" and "He Reads Truth"
                                            content.
                                        </p>
                                    </div>
                                    <a
                        ...
                        <ScrollAnimation animateIn="zoomIn">
                            <div className="proj-1">
                                <div className="proj-1-rightside">
                                    ...
                                    <div className="proj-description">
                                        <p className="proj-description-text">
                                            A website for solo travelers who can
                                            rent single chairs around the world
                                            inspired by Airbnb.
                                        </p>
                                    </div>
                                    <div className="proj-1-links">
                        ...
                        <ScrollAnimation animateIn="zoomIn">
                            <div className="proj-2">
                                <div className="proj-2-rightside">
                                    ...
                                    <div className="proj-description">
                                        <p className="proj-description-text">
                                            A “CRM” web application that allows
                                            schools to send reminders to parents
                                            via SMS messaging.
                                        </p>
                                    </div>
                                    <a
                        ...
                        <ScrollAnimation animateIn="zoomIn">
                            <div className="proj-1">
                                <div className="proj-1-rightside">
                                    ...
                                    <div className="proj-description">
                                        <p className="proj-description-text">
                                            A data visualization site that helps
                                            users make healthier food choices by
                                            tracking their nutritional facts.
                                        </p>
                                    </div>
                                    <div className="proj-1-links">
                                        <a
                        ...
                        <section className="noteworthy-container">
                            <ScrollAnimation animateIn="fadeIn">
                                <h4 className="header-4">Upcoming projs</h4>
                            </ScrollAnimation>
                                        ...
                                        <div className="inner-cont">
                                            <header>
                                                ...
                                                <div className="descript-note">
                                                    ...
                                                    football users dominate
                                                    their leagues by tracking,
                                                    sorting, and analyzing
                                                    statisical data of NFL
                                                    athletes.
                                                </div>
                                            </header>
                                            <footer>
                ...
                <div className="final-container">
                    ...
                    <div className="final-text">
                        As of {today} I am looking for a software engineer
                        position in the New York Metropolitan area. If you think
                        I would be a good fit for your company please don't
